...
import { apiRequest, isThereToken } from "@/lib/api"
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
          <Card className="w-full max-w-2xl p-8 text-center animate-fade-in">
            <div className="mb-8">
              ...
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Adding Your New AI Assistant</h1>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <Card className="w-full max-w-2xl p-8 animate-fade-in">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Add a New AI Assistant</h1>
            <p className="text-gray-600">Create another custom chatbot for your website</p>
          </div>
          {/* Progress */}
          <div className="mb-8">
          ...
          <div className="flex justify-between items-center mt-8 pt-6 border-t border-gray-200">
            ...
            >
              {currentStep === totalSteps ? "Add Chatbot" : "Continue"}
